...
/**
 * \file    test/phpunit/MMIPaymentsFunctionalTest.php
 * \ingroup mmipayments
...
/**
 * Class MMIPaymentsFunctionalTest
 *
 ...
 *
 * @package Testmmipayments
 */
class MMIPaymentsFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modMMIPayments')->click();
		} else {
			// Disable the module
			$this->byHref('modMMIPayments')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/mmipayments/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('mmipayments/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/mmipayments/admin/about.php');
		$this->authenticate();
		return $this->assertContains('mmipayments/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('mmipaymentswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMMIPayments_MMIPaymentsTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMMIPayments_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
